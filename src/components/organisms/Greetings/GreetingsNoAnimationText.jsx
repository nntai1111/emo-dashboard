...
import { LoginMessageForm, MessagesMove } from "@/components/molecules";

const GreetingsNoAnimationText = () => {
  ...
  return (
    <>
      <section
        ...
        <div className="relative mx-[calc(50%-50vw)] w-[100vw] max-w-[100vw] px-4 sm:px-8 lg:px-12 overflow-visible z-[10]">
          ...
          <div>
            <div className="max-w-6xl mx-auto py-8 sm:py-10 lg:py-0 relative">
              <div className={`${styles.dancingScript} text-white`}>
                <h1 className="tracking-tight leading-tight mb-4 pb-2 relative text-left text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl">
                  Bạn có ổn không?
                  {!reduceMotion && (
                    <motion.span
                ...
                <h2 className="tracking-tight text-left text-white/90 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">
                  Đôi khi câu trả lời thật khó nói...
                </h2>
              </div>
            </div>
            ...
            <div className="relative w-full mt-3 sm:mt-8 font-sans overflow-x-clip overflow-y-visible min-h-[28rem] md:min-h-[32rem] lg:min-h-[40rem]">
              <LoginMessageForm className="relative lg:absolute lg:left-[10%] lg:top-0 z-[20]" />
...
export default GreetingsNoAnimationText;
