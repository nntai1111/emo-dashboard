...
import RenameAliasModal from "../components/molecules/RenameAliasModal";
...
const MobileProfilePage = ({ onBack }) => {
  ...
  // Loading state nếu chưa có user data
  if (!user) {
    return (
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      // Dispatch event để thông báo auth changed
      ...
      // Vẫn redirect về onboarding page
      navigate("/onboarding", { replace: true });
    }
  };
  ...
  return (
    <motion.div
      ...
      className="min-h-dvh bg-gray-50 dark:bg-gray-900"
    >
      {/* Header */}
            ...
            {showSettingsMenu && (
              <>
                ...
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-[#1C1C1E] rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50"
                >
                  <button
                    onClick={() => {
                      setShowSettingsMenu(false);
                      navigate("/AIChatBoxWithEmo"); // Thay bằng route thật của bạn
                    }}
                    className="flex items-center gap-3 w-full px-4 py-3 text-base text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                  >
                    <MessageSquare className="w-4 h-4" />
                    <span>{t("profile.emoChat")}</span>
                  </button>
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 w-full px-4 py-3 text-base text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                  >
      ...
      {/* Cover Image */}
      <div className="h-20 bg-gradient-to-br from-purple-400 via-pink-500 to-orange-400 relative">
      ...
      <div className="relative px-4 pb-4">
        ...
        <div className="mb-4">
          ...
          <div className="whitespace-pre-line text-gray-700 dark:text-gray-300 mb-4 text-base">
            {user.bio}
          </div>
        ...
        {/* Stats */}
        <div className="flex space-x-4 mb-4 text-base overflow-x-auto">
          <div className="text-center min-w-[60px]">
            <div className="font-bold text-gray-900 dark:text-white">
              {user.stats.posts}
            </div>
            <div className="text-gray-500 dark:text-gray-400 text-base">{t("profile.posts")}</div>
          </div>
          {/* <div className="text-center min-w-[60px]">
            <div className="font-bold text-gray-900 dark:text-white">
          ...
          <div className="text-center min-w-[60px]">
            ...
            <div className="text-gray-500 dark:text-gray-400 text-base">{t("profile.likesReceived")}</div>
          </div>
          <div className="text-center min-w-[60px]">
            <div className="font-bold text-gray-900 dark:text-white">
              {user.stats.likesGiven}
            </div>
            <div className="text-gray-500 dark:text-gray-400 text-base">{t("profile.likesGiven")}</div>
          </div>
        </div>
          ...
          <nav className="flex space-x-6">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center space-x-1 py-2 px-1 border-b-2 font-medium text-base transition-colors duration-200 whitespace-nowrap ${activeTab === tab.id
